...
describe('ProductGridComponent', () => {
  ...
  it('devrait afficher les bonnes données de produit dans le tableau', () => {
    fixture.detectChanges();
  ...
  it('devrait afficher le bon format de date', () => {
    fixture.detectChanges();
  ...
  it('devrait formater le prix correctement', () => {
    fixture.detectChanges();
